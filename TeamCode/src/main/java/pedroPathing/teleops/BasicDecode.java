...
public class BasicDecode extends OpMode {
    ...
    private static final int medVelocity = 2000;
    private static final int farVelocity = 2000;
    private static final int maxVelocity = 2300;
    ...
    public void loop() {
        ...
        if (gamepad2.options) {
            ...
            ((DcMotorEx) shooter2).setVelocity(bankVelocity - 870);
            if (((DcMotorEx) shooter1).getVelocity() >= bankVelocity - 3) {
                intake.setPower(1);
            } else {
                intake.setPower(0);
            }
        ...
        ((DcMotorEx) shooter2).setVelocity(medVelocity - 500);
        if (((DcMotorEx) shooter1).getVelocity() >= medVelocity - 3) {
            intake.setPower(1);
        } else {
            intake.setPower(0);
        }
...
//----------------------------------------------------------------------------
            ...
            //----------------------------------------------------------------------------
            if (gamepad2.dpad_left) {// outtakes balls
                intake.setPower(1);
            } else {
                intake.setPower(0);
            }
