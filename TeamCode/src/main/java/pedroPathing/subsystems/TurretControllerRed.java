...
public class TurretControllerRed {
    ...
    public static final double GOAL_X = 65;
    public static final double GOAL_Y = 15;
    ...
    public static double MIN_ANGLE_RAD = Math.toRadians(0);
    public static double MAX_ANGLE_RAD = Math.toRadians(50);

    private double kP = 0.2;
    private double kD = 0.009;
    private double kS = 0.13;
    ...
    public TurretControllerRed(HardwareMap hw, String turretMotorName, Follower follower) {
