...
public class LConstants {
    static {
        DriveEncoderLocalizer.TURN_TICKS_TO_RADIANS = 6.6846;
        DriveEncoderLocalizer.FORWARD_TICKS_TO_INCHES = 47.8025;
        DriveEncoderLocalizer.STRAFE_TICKS_TO_INCHES = 47.3887;
